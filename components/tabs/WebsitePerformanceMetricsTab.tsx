...
import AddMetric from '../metric/AddMetric'
...
const WebsitePerformanceMetrics = () => {
  ...
  return (
    ...
    <div className='flex items-start justify-center xl:flex-row flex-col'>
        <div className='flex flex-col xl:w-4/5 w-full justify-center'>
        ...
        <div className='xl:w-2/5 w-full justify-center items-start flex xl:flex-col sm:flex-row flex-col xl:mx-4 mb-5 xl:mt-0 mt-5'>
